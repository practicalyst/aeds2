...
class CiframentoRecursivo { 
    ...
    public static String cifrarRecursivo(String frase, String cifra, int n){
        if(n >= frase.length()){
            return cifra;
        }
        int c = (int) frase.charAt(n) + 3;
        cifra += (char) c;
        
        return cifrarRecursivo(frase, cifra, n + 1);
    ...
    public static void main(String[] args){
        ...
        while(true){
            ...
            MyIO.println(cifrarRecursivo(input, "", 0));
        }
